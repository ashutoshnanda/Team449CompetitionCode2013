...
KeepAliveTimeout 60
		...
		<Item Name="TypeDefs" Type="Folder">
			...
			<Item Name="Inputs_All.ctl" Type="VI" URL="../Inputs_All.ctl"/>
			<Item Name="Constants_All.ctl" Type="VI" URL="../Constants_All.ctl"/>
			<Item Name="Outputs_All.ctl" Type="VI" URL="../Outputs_All.ctl"/>
			<Item Name="Command_Inputs.ctl" Type="VI" URL="../Command_Inputs.ctl"/>
		</Item>
		<Item Name="Team Code" Type="Folder">
			...
			<Item Name="Get_All_Sensor_Inputs.vi" Type="VI" URL="../Get_All_Sensor_Inputs.vi"/>
		</Item>
		<Item Name="Support Code" Type="Folder">
			<Item Name="Get Robot Competition Mode.vi" Type="VI" URL="../Get Robot Competition Mode.vi"/>
			<Item Name="Elapsed Times.vi" Type="VI" URL="../Elapsed Times.vi"/>
		</Item>
		<Item Name="Tank Drive" Type="Folder">
			<Item Name="BeginTankDrive.vi" Type="VI" URL="../tankdrive/BeginTankDrive.vi"/>
			<Item Name="Input_Sensors_Drive.vi" Type="VI" URL="../tankdrive/Input_Sensors_Drive.vi"/>
			<Item Name="Input_Sensors_Drive.ctl" Type="VI" URL="../tankdrive/Input_Sensors_Drive.ctl"/>
			<Item Name="Constants_Drive.ctl" Type="VI" URL="../tankdrive/Constants_Drive.ctl"/>
			<Item Name="Output_Wheel_Speeds.ctl" Type="VI" URL="../tankdrive/Output_Wheel_Speeds.ctl"/>
			<Item Name="TankDriveCalc.vi" Type="VI" URL="../tankdrive/TankDriveCalc.vi"/>
			<Item Name="TankDriveOutput.vi" Type="VI" URL="../tankdrive/TankDriveOutput.vi"/>
			<Item Name="Input_Commands_Drive.ctl" Type="VI" URL="../tankdrive/Input_Commands_Drive.ctl"/>
			<Item Name="InputDriveCommands.vi" Type="VI" URL="../tankdrive/InputDriveCommands.vi"/>
		</Item>
		<Item Name="Conveyor" Type="Folder">
			<Item Name="Sensor_Input_Conveyor.ctl" Type="VI" URL="../Conveyor/Sensor_Input_Conveyor.ctl"/>
			<Item Name="Input_Sensors_Conveyor_2.vi" Type="VI" URL="../Conveyor/Input_Sensors_Conveyor_2.vi"/>
			<Item Name="Conveyor_constants.ctl" Type="VI" URL="../Conveyor/Conveyor_constants.ctl"/>
			<Item Name="calc_conveyor_module.vi" Type="VI" URL="../Conveyor/calc_conveyor_module.vi"/>
			<Item Name="Conveyor module state.ctl" Type="VI" URL="../Conveyor/Conveyor module state.ctl"/>
			<Item Name="tester_calc_conveyor_single_module.vi" Type="VI" URL="../Conveyor/tester_calc_conveyor_single_module.vi"/>
			<Item Name="begin_conveyor.vi" Type="VI" URL="../Conveyor/begin_conveyor.vi"/>
			<Item Name="Conveyor_outputs.ctl" Type="VI" URL="../Conveyor/Conveyor_outputs.ctl"/>
			<Item Name="output_conveyor.vi" Type="VI" URL="../Conveyor/output_conveyor.vi"/>
			<Item Name="calc_conveyor.vi" Type="VI" URL="../Conveyor/calc_conveyor.vi"/>
			<Item Name="Input_Command_Conveyor.ctl" Type="VI" URL="../Conveyor/Input_Command_Conveyor.ctl"/>
			<Item Name="Input_Commands_Conveyor.vi" Type="VI" URL="../Conveyor/Input_Commands_Conveyor.vi"/>
		</Item>
		<Item Name="Joystick" Type="Folder">
			<Item Name="Begin_Joystick.vi" Type="VI" URL="../Begin_Joystick.vi"/>
			<Item Name="Input_Single_Joystick.ctl" Type="VI" URL="../Input_Single_Joystick.ctl"/>
			<Item Name="Input_All_Joysticks.ctl" Type="VI" URL="../Input_All_Joysticks.ctl"/>
			<Item Name="Get_Joystick_Inputs.vi" Type="VI" URL="../Get_Joystick_Inputs.vi"/>
		</Item>
		<Item Name="Ultrasonic" Type="Folder">
			<Item Name="begin_ultrasonicsensor.vi" Type="VI" URL="../Ultra Sonic Sensor/begin_ultrasonicsensor.vi"/>
			<Item Name="test_ultrasonic.vi" Type="VI" URL="../Ultra Sonic Sensor/test_ultrasonic.vi"/>
		</Item>
		<Item Name="IR" Type="Folder">
			<Item Name="Variable Angle Flywheel" Type="Folder">
				<Item Name="Sensor_Inputs_FlyWheel.ctl" Type="VI" URL="../Flywheel/Sensor_Inputs_FlyWheel.ctl"/>
				<Item Name="FlywheelVariableAngleControl.vi" Type="VI" URL="../Flywheel/FlywheelVariableAngleControl.vi"/>
				<Item Name="Set_FlyWheelOutput.vi" Type="VI" URL="../Flywheel/Set_FlyWheelOutput.vi"/>
				<Item Name="Get_Sensor_Inputs_FlyWheel.vi" Type="VI" URL="../Flywheel/Get_Sensor_Inputs_FlyWheel.vi"/>
				<Item Name="Begin_FlyWheel.vi" Type="VI" URL="../Flywheel/Begin_FlyWheel.vi"/>
				<Item Name="Outputs_Flywheel.ctl" Type="VI" URL="../Flywheel/Outputs_Flywheel.ctl"/>
			</Item>
			<Item Name="Begin_IR_Range_Finder.vi" Type="VI" URL="../IR Range Finder/Begin_IR_Range_Finder.vi"/>
			<Item Name="Test_IR_Range_Finder.vi" Type="VI" URL="../IR Range Finder/Test_IR_Range_Finder.vi"/>
			<Item Name="Input_IR.vi" Type="VI" URL="../IR Range Finder/Input_IR.vi"/>
		</Item>
		<Item Name="Utilities" Type="Folder">
			<Item Name="Square Inputs.vi" Type="VI" URL="../../Utilities/Square Inputs.vi"/>
			<Item Name="Degrees_To_Radians.vi" Type="VI" URL="../../Vision/Degrees_To_Radians.vi"/>
			<Item Name="Radians_To_Degrees.vi" Type="VI" URL="../../Vision/Radians_To_Degrees.vi"/>
			<Item Name="Ft_To_Inches.vi" Type="VI" URL="../../Utilities/Ft_To_Inches.vi"/>
			<Item Name="RadiansToDegrees.vi" Type="VI" URL="../../KinectTest/RadiansToDegrees.vi"/>
			<Item Name="ApplyDeadBand.vi" Type="VI" URL="../../Utilities/ApplyDeadBand.vi"/>
			<Item Name="Remove Deadband.vi" Type="VI" URL="../../Utilities/Remove Deadband.vi"/>
		</Item>
		<Item Name="Turret" Type="Folder">
			<Item Name="Input_Sensors_Turret.vi" Type="VI" URL="../Turret/Input_Sensors_Turret.vi"/>
			<Item Name="Output_Turret.vi" Type="VI" URL="../Turret/Output_Turret.vi"/>
			<Item Name="Begin_Turret.vi" Type="VI" URL="../Turret/Begin_Turret.vi"/>
			<Item Name="Turret_Main_Calc.vi" Type="VI" URL="../Turret/Turret_Main_Calc.vi"/>
			<Item Name="Turret_Desired_Position_Control.vi" Type="VI" URL="../Turret/Turret_Desired_Position_Control.vi"/>
			<Item Name="Turret_Reset_Control.vi" Type="VI" URL="../Turret/Turret_Reset_Control.vi"/>
			<Item Name="Calc_Turret.vi" Type="VI" URL="../Turret/Calc_Turret.vi"/>
			<Item Name="Inputs_Sensors_Turret.ctl" Type="VI" URL="../Turret/Inputs_Sensors_Turret.ctl"/>
			<Item Name="Outputs_Turret.ctl" Type="VI" URL="../Turret/Outputs_Turret.ctl"/>
			<Item Name="Input_Commands_Turret.vi" Type="VI" URL="../Turret/Input_Commands_Turret.vi"/>
			<Item Name="Inputs_Commands_Turret.ctl" Type="VI" URL="../Turret/Inputs_Commands_Turret.ctl"/>
		</Item>
		<Item Name="Roller" Type="Folder">
			<Item Name="Calc_Roller.vi" Type="VI" URL="../Roller/Calc_Roller.vi"/>
			<Item Name="Outputs_Roller.ctl" Type="VI" URL="../Roller/Outputs_Roller.ctl"/>
			<Item Name="Output_Roller.vi" Type="VI" URL="../Roller/Output_Roller.vi"/>
			<Item Name="Begin_Roller.vi" Type="VI" URL="../Roller/Begin_Roller.vi"/>
		</Item>
		<Item Name="Camera" Type="Folder">
			<Item Name="Set_LEDs.vi" Type="VI" URL="../../Vision/Set_LEDs.vi"/>
			<Item Name="Open_LEDs.vi" Type="VI" URL="../Open_LEDs.vi"/>
			<Item Name="Init_Camera.vi" Type="VI" URL="../Init_Camera.vi"/>
			<Item Name="Process_And_Aim.vi" Type="VI" URL="../../Vision/Process_And_Aim.vi"/>
			<Item Name="Process_Rect.vi" Type="VI" URL="../../Vision/Process_Rect.vi"/>
			<Item Name="Calc_Distance_Angle.vi" Type="VI" URL="../../Vision/Calc_Distance_Angle.vi"/>
			<Item Name="Calibrate.vi" Type="VI" URL="../../Vision/Calibrate.vi"/>
			<Item Name="Init_Images.vi" Type="VI" URL="../../Vision/Init_Images.vi"/>
			<Item Name="Image Cluster.ctl" Type="VI" URL="../../Vision/Image Cluster.ctl"/>
			<Item Name="Take_2_Pics.vi" Type="VI" URL="../../Vision/Take_2_Pics.vi"/>
			<Item Name="Load Images From File.vi" Type="VI" URL="../../Vision/Load Images From File.vi"/>
			<Item Name="Find_Top_Target.vi" Type="VI" URL="../../Vision/Find_Top_Target.vi"/>
			<Item Name="FindAngle.vi" Type="VI" URL="../../KinectTest/FindAngle.vi"/>
			<Item Name="Distance.vi" Type="VI" URL="../../KinectTest/Distance.vi"/>
		</Item>
		<Item Name="Kinnect" Type="Folder">
			<Item Name="KinectInputs.ctl" Type="VI" URL="../tankdrive/Kinect/KinectInputs.ctl"/>
			<Item Name="ArmPiecesDetected.vi" Type="VI" URL="../../KinectTest/ArmPiecesDetected.vi"/>
			<Item Name="ArmAngleFinding.vi" Type="VI" URL="../../KinectTest/ArmAngleFinding.vi"/>
			<Item Name="ArmAngleFindingYZ.vi" Type="VI" URL="../../KinectTest/ArmAngleFindingYZ.vi"/>
			<Item Name="GestureRecognitionTest.vi" Type="VI" URL="../../KinectTest/GestureRecognitionTest.vi"/>
		</Item>
		<Item Name="Bridge Tipper" Type="Folder">
			<Item Name="Outputs_Tipper.ctl" Type="VI" URL="../Bridge Tipper/Outputs_Tipper.ctl"/>
			<Item Name="Calc_Tipper.vi" Type="VI" URL="../Bridge Tipper/Calc_Tipper.vi"/>
			<Item Name="Output_Tipper.vi" Type="VI" URL="../Bridge Tipper/Output_Tipper.vi"/>
			<Item Name="Begin_Tipper.vi" Type="VI" URL="../Bridge Tipper/Begin_Tipper.vi"/>
			<Item Name="Input_Commands_Tipper.vi" Type="VI" URL="../Bridge Tipper/Input_Commands_Tipper.vi"/>
			<Item Name="Inputs_Tipper.ctl" Type="VI" URL="../Bridge Tipper/Inputs_Tipper.ctl"/>
		</Item>
		<Item Name="Turret Roller" Type="Folder">
			<Item Name="T_Roller_constants.ctl" Type="VI" URL="../Turret Roller/T_Roller_constants.ctl"/>
			<Item Name="T_Roller_speed.ctl" Type="VI" URL="../Turret Roller/T_Roller_speed.ctl"/>
		</Item>
		<Item Name="Robot Main.vi" Type="VI" URL="../Robot Main.vi"/>
		<Item Name="Get_Driver_Commands.vi" Type="VI" URL="../Get_Driver_Commands.vi"/>
		<Item Name="Process Inputs.vi" Type="VI" URL="../Process Inputs.vi"/>
		<Item Name="EnsurePIDSettings.vi" Type="VI" URL="../EnsurePIDSettings.vi"/>
		<Item Name="Inputs_Camera.ctl" Type="VI" URL="../Inputs_Camera.ctl"/>
		<Item Name="Autonomous Shooting State.ctl" Type="VI" URL="../Autonomous Shooting State.ctl"/>
		<Item Name="Dashboard Controls.ctl" Type="VI" URL="../Dashboard Controls.ctl"/>
		<Item Name="Input_Dashboard_Commands.vi" Type="VI" URL="../Input_Dashboard_Commands.vi"/>
		<Item Name="Input_Commands_Roller.ctl" Type="VI" URL="../Roller/Input_Commands_Roller.ctl"/>
		<Item Name="Input_Roller_Commands.vi" Type="VI" URL="../Roller/Input_Roller_Commands.vi"/>
		<Item Name="Input_Commands_Flywheel.ctl" Type="VI" URL="../Flywheel/Input_Commands_Flywheel.ctl"/>
		<Item Name="Input_Commands_Flywheel.vi" Type="VI" URL="../Flywheel/Input_Commands_Flywheel.vi"/>
		<Item Name="calc_conveyor_2.vi" Type="VI" URL="../Conveyor/calc_conveyor_2.vi"/>
		<Item Name="Output_Conveyor_2.vi" Type="VI" URL="../Conveyor/Output_Conveyor_2.vi"/>
		<Item Name="Sum Last 5.vi" Type="VI" URL="../../Utilities/Sum Last 5.vi"/>
		<Item Name="Encoder_To_Degrees.vi" Type="VI" URL="../../Utilities/Encoder_To_Degrees.vi"/>
		<Item Name="Degrees_To_Encoder.vi" Type="VI" URL="../../Utilities/Degrees_To_Encoder.vi"/>
		<Item Name="Acquire_Image_Diff.vi" Type="VI" URL="../Acquire_Image_Diff.vi"/>
		<Item Name="Get_Image_Diff_Notifier.vi" Type="VI" URL="../Get_Image_Diff_Notifier.vi"/>
		<Item Name="Pixel to Vertical Angle Offset.vi" Type="VI" URL="../Pixel to Vertical Angle Offset.vi"/>
		<Item Name="Auto_Layup.vi" Type="VI" URL="../Auto_Layup.vi"/>
		<Item Name="Auto_Shooting.vi" Type="VI" URL="../Auto_Shooting.vi"/>
		<Item Name="dAngle_To_Encoder.vi" Type="VI" URL="../Turret/dAngle_To_Encoder.vi"/>
		<Item Name="Aim_Turret_with_Camera.vi" Type="VI" URL="../Turret/Aim_Turret_with_Camera.vi"/>
		<Item Name="Dependencies" Type="Dependencies">
			<Item Name="vi.lib" Type="Folder">
				...
				<Item Name="WPI_CANJaguar_GetSpeedReference.vi" Type="VI" URL="/&lt;vilib&gt;/Rock Robotics/WPI/CAN/Jaguar/Configuration/WPI_CANJaguar_GetSpeedReference.vi"/>
			...
			<Item Name="Toggle.vi" Type="VI" URL="../../Utilities/Toggle.vi"/>
			<Item Name="RisingEdge.vi" Type="VI" URL="../../Utilities/RisingEdge.vi"/>
			<Item Name="Sensor_Input_ConveyorV2.ctl" Type="VI" URL="../Conveyor/Sensor_Input_ConveyorV2.ctl"/>
			<Item Name="Conveyor_outputsV2.ctl" Type="VI" URL="../Conveyor/Conveyor_outputsV2.ctl"/>
			<Item Name="3-Ball-Conveyor_Module_State.ctl" Type="VI" URL="../Conveyor/3-Ball-Conveyor_Module_State.ctl"/>
			<Item Name="Calc_3-Ball-Conveyor_Module.vi" Type="VI" URL="../Conveyor/Calc_3-Ball-Conveyor_Module.vi"/>
			<Item Name="Begin_ConveyorV2.vi" Type="VI" URL="../Conveyor/Begin_ConveyorV2.vi"/>
			<Item Name="T_Roller module state.ctl" Type="VI" URL="../Conveyor/T_Roller module state.ctl"/>
			<Item Name="Turret_roller_module.vi" Type="VI" URL="../Conveyor/Turret_roller_module.vi"/>
			<Item Name="Input_Sensors_Conveyor.vi" Type="VI" URL="../Conveyor/Input_Sensors_Conveyor.vi"/>
			<Item Name="FallingEdge.vi" Type="VI" URL="../../Utilities/FallingEdge.vi"/>
			<Item Name="LookUpTable.vi" Type="VI" URL="../Flywheel/LookUpTable.vi"/>
			<Item Name="Target Validity Test.vi" Type="VI" URL="../../Vision/Target Validity Test.vi"/>
		...
		<Item Name="Build Specifications" Type="Build">
			<Item Name="FRC Robot Boot-up Deployment" Type="{69A947D5-514E-4E75-818E-69657C0547D8}">
				...
				<Property Name="RTExe_localDestPath" Type="Path">/C/Documents and Settings/Robot/My Documents/2012/2012 Code/TestProject/Builds</Property>
				<Property Name="RTExe_localDestPathType" Type="Str">&lt;none&gt;</Property>
				<Property Name="Source[0].itemID" Type="Str">{683A67FE-EB75-4FF7-B9FD-CFA6C79F6FC3}</Property>
